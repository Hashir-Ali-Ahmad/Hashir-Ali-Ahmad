...
![Lenis](https://img.shields.io/badge/Lenis-00ADB5?style=flat-square&logoColor=white)
...
|:--|:--|:--|
| 🤖 **[AI Interview Platform](https://github.com/zainab674/ai-interview)** | AI mock-interview platform — speech recognition, live WebSocket sessions, Gemini-generated questions & feedback | `React` `NestJS` `Gemini AI` `WebSockets` |
| 🎨 **[Personal Portfolio](https://hashiraliahmad.vercel.app)** | Premium animated portfolio — smooth scroll, scroll-driven animations & 3D visuals | `Next.js` `R3F` `GSAP` `Lenis` |
